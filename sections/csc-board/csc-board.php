<?php // This is where you add the page title, it also displays in the level 1 heading below
	...
	<p class="sectiontitle">CSC Board</p>
	...
	<h2>Remuneration</h2>
		<p>
			The Remuneration Tribunal, established under the <em>Remuneration Tribunal Act 1973</em>, determines the remuneration of directors including the Chair and members of the Audit and Risk Management Committee and the reconsideration committees. Remuneration is disclosed in CSC’s annual financial statements included in this report.
		</p>
	<h2>Director indemnity</h2>
		<p>
			Anything done, or omitted to be done, in good faith by a director or a delegate of the Board, in the performance of functions under relevant CSC legislation will not subject that person to any action, liability, claim or demand. CSC may, however, be subject to an action, liability, claim or demand. In addition to the legislative indemnity, CSC holds trustee liability and comprehensive crime insurance which complies with the <em>Corporations Act 2001</em> and has given a deed of indemnity, insurance and access to each director.
		</p>
  <div id="director-section">
	<h2>Directors in 2015–16</h2>
        ...
        <h3 class="callout bg-success">Mrs Patricia Cross</h3>
			<h4>Appointed 1 July 2014 to 30 June 2017</h4>
				<ul>
					...
					<li>Chairman of the Board Governance Committee</li>
					<li>Chairman of the Remuneration and HR Committee</li>
				</ul>		
				<p>
...
<h3 class="callout bg-success">Mr John McCullagh</h3>
			<h4>Appointment ended on 30 June 2016</h4>
				<ul>
					...
					<lI>Member of the Audit and Risk Management Committee</li>
					<li>Chairman of the APS Reconsideration Advisory Committee</li>
					<li>Deputy Chairman of the MilitarySuper Reconsideration Committee</li>
					<li>Deputy Chairman of the Defence Force Case Assessment Panel</li>
				</ul>
				<p>
...
<h3 class="callout bg-success">Dr Michael John Vertigan, AC</h3>
			<h4>Appointment ended on 30 June 2016</h4>
				<ul>
					<li>Director since 1 July 2011</li>
					<li>Chairman of the Audit and Risk Management Committee</li>
				</ul>
				<p>
