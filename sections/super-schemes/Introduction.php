    ...
    <div class="container">
		<div class="row">
			...
			<div class="col-sm-8 col-xs-11 content" id="startContent">
				...
				<p>Administering CSC’s super schemes involves:</p>
				<ul>
					<li>calculating and paying benefits,</li>
					<li>responding to member and employer enquiries, and</li>
					<li>maintaining accounts for contributors, preservers and pensioners.</li>
				</ul>
				<p>
				...
				<p>
				2015–16 performance against services levels for each super scheme is detailed below. Further detail is included in the <strong>Annual Performance Statement </strong>on pages 18–20. </p>
				<h4>Defined benefit schemes</h4>
				<table class="table first-col-dark last-col-dark">
					<caption>Table 11: Defined benefit scheme service standard in 2015–16</caption>
					<thead>
						<tr>
							<th>&nbsp;</th>
							<th>CSS*</th>
							...
							<th>Military</th>
							<th>ADF total</th>
							<th> Total across DB schemes</th>
						</tr>
					</thead>
					<tfoot>
                    <tr>
						<td colspan="8">* CSS and PSS schemes share a number of service standards and as such the scheme APS total results do not reconcile.</td>
                        </tr>
					</tfoot>
					<tbody class="five-or-more">
						<tr>
							<td>Number of service standards</td>
							<td>64</td>
							<td>65</td>
							<td class="dark-green-cell">101</td>
							<td>64</td>
							<td>71</td>
							<td class="dark-green-cell">135</td>
							<td>236</td>
						</tr>
						<tr>
							<td>Number of standards met</td>
							<td>60</td>
							<td>62</td>
							<td class="dark-green-cell">97</td>
							<td>60</td>
							<td>61</td>
							<td class="dark-green-cell">121</td>
							<td>218</td>
						</tr>
						<tr>
							<td class="dark-grey-cell">% achieved</td>
							<td class="light-grey-cell">94%</td>
							<td class="light-grey-cell">95%</td>
							<td class="dark-grey-cell">96%</td>
							<td class="light-grey-cell">94%</td>
							<td class="light-grey-cell">86%</td>
							<td class="dark-grey-cell">90%</td>
							<td class="dark-grey-cell">92%</td>
						</tr>
					</tbody>
				</table>
				<h4>Defined contribution schemes</h4>
				<table class="table first-col-dark last-col-dark four-col">
					<caption>Table 12: Defined contribution scheme service standard in 2015–16</caption>
					<thead>
						<tr>
							<th>&nbsp;</th>
							<th>PSSap</th>
							<th>CSCri</th>
							<th>Total across DC schemes</th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							<td class="dark-grey-cell">% achieved</td>
							<td class="light-grey-cell">86%</td>
							<td class="light-grey-cell">97%</td>
							<td class="dark-grey-cell">91%</td>
						</tr>
					</tbody>
				</table>
				<h4>Review of decisions and complaints</h4>
				<p>
				...
				<ul>
					<li>general information over the phone and online,</li>
					<li>secure management of their account online</li>
					<li>education and general advice at a public or workplace seminar, online webinar or one-on-one information session, and</li>
					<li>personal financial advice from a qualified financial planner from Industry Fund Services (IFS).</li>
				</ul>
				<h4>Personal financial advice</h4>
				<p>
				...
				<h3>Public &amp; workplace seminars</h3>
				<p>
                ...
                <div class="row">
                <div>
				<p class="chart-title">Chart 1: Workshops and seminars on public sector schemes</p>
				<img src="../../images/charts/APS_seminars.svg" alt="bar chart relating to workshops and seminars on PSS"/>
                </div>
                </div>
                </div>
				<p>
                ...
                <div class="row">
                <div>
				<p class="chart-title">Chart 2: Seminars on military schemes</p>
				<img src="../../images/charts/military_seminars.svg" alt="bar chart relating to seminars on Military schemes"/>
                </div>
                </div>
                </div>
				<p>
                ...
                <div class="row">
                <div>
				<p class="chart-title">Chart 3: One-on-one information sessions for military scheme members</p>
				<img src="../../images/charts/MS_info_sessions.svg" alt="bar chart relating to one on one information sessions on Military schemes"/>
                </div>
                </div>
                </div>
				<p>
				...
				<h2>Scheme legislation &amp; trust deeds</h2>
				<p>
