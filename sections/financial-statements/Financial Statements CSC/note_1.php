    ...
    <div class="container">
		<div class="row">
			...
			<div class="col-xs-8 content" id="startContent">
				...
				<table class="column_bold csc-tri">
					<thead>
						<tr>
							<th>&nbsp;</th>
							<th>&nbsp;</th>
					...
					<tbody>
						...
						<tr>
							<td>Total Assets</td>
							<td>&nbsp;</td>
							<td class="border_top_bottom">2,948</td>
						</tr>
						<tr>
							<td>Liabilities</td>
							<td>&nbsp;</td>
						...
						<tr>
							...
							<td>&nbsp;</td>
							<td class="border_top_bottom">(3,720)</td>
						</tr>
						<tr>
							<td>Net Liabilities</td>
							<td>&nbsp;</td>
							<td class="border_top_bottom">(772)</td>
						</tr>
					</tbody>	
				</table>
				<h3>The Basis of Preparation</h3>
				<p>
					The financial statements are general purpose financial statements and are required by section 42 of the <em>Public Governance, Performance and Accountability Act 2013</em>.
				</p>
				<p>
				...
				<ol class="lower_alpha">
					...
					<li>Australian Accounting Standards and Interpretations issued by the Australian Accounting Standards Board (AASB) that apply for the reporting period.</li>
				</ol>
				<p>
				...
				<h3>New Accounting Standards</h3>
				<p><em>Adoption of New Australian Accounting Standard Requirements</em></p>
				<p>
				...
				<p><em>Future Australian Accounting Standard Requirements</em></p>
				<p>
					The following new and revised standards were issued by the Australian Accounting Standards Board prior to the sign-off date and are expected to have a material impact on the entity’s financial statements for future reporting period(s):
				</p>
				...
				<p><sup>1.</sup>The entity’s expected initial application date is when the accounting standard becomes operative at the beginning of the entity’s reporting period.</p>
				<p>
				...
				<ol class="lower_alpha">
					<li>where the amount of GST incurred is not recoverable from the Australian Taxation Office; and</li>
					<li>for receivables and payables.</li>
				</ol>
				<h3>Controlled entities</h3>
				<p>
				...
				<h2>Reporting of Administered activities</h2>
				<p>The FRR requires disclosure where one entity has drawn against a Special Appropriation which is the responsibility of another entity.</p>
				<p>Administered assets, liabilities, revenue and expenses are those items which are controlled by the Government and were managed or over sighted by the entity on its behalf including:</p>
				<ul>
					<li>Superannuation benefit payments</li>
				...
				<h3>1922, CSS and PSS schemes</h3>
				<p>
				...
				<ul>
					<li><em>Superannuation Act 1922;</em></li>
					<li><em>Superannuation Act 1976;</em></li>
					<li><em>Superannuation Act 1990;</em></li>
					<li><em>Same Sex Relationships (Equal Treatment in Commonwealth Laws - Superannuation) Act 2008;</em></li>
					<li><em>Governance of Australian Government Superannuation Schemes Act 2011 - s35(3)(a); and</em></li>
					<li><em>Governance of Australian Government Superannuation Schemes Act 2011 - s35(4)</em></li>
				</ul>
				<p>
					In addition, CSC was delegated third party access rights by Finance for the funding of legal and incidental costs of superannuation claims, and Act of Grace payments. These were appropriated under <em>Appropriation Act (No. 1) 2015-2016</em> and <em>Appropriation Act (No. 2) 2015-2016</em>.
				</p>
				<p>
					The funded components of the CSS and PSS Schemes are reported in their respective financial statements.
				</p>
				<h3>DFRB, DFRDB and MSB Schemes</h3>
				<p>
				...
				<ul>
					<li><em>Defence Forces Retirement Benefits Act 1948;</em></li>
					<li><em>Defence Force Retirement and Death Benefits Act 1973;</em> and</li>
					<li><em>Military Superannuation Benefits Act 1991.</em></li>
				</ul>
				<p>
				...
				<h3>Administered Cash Transfers to and from the Official Public Account</h3>
				<p>
				...
				<h3>Events After the Reporting Period</h3>
				<p>
				...
				<p>
				 ...
				 <ul class="bottomnav">
					<li>
						<a href="fs_notes_landing.php" class="back">Previous &#8211; CSC financial statement notes</a>
					</li>
					<li>
						<a href="#topnav" class="top">Top</a>
					</li>
					<li>
						<a href="note_2.php" class="next">Next &#8211; Note 2</a>
					</li>
				</ul>
		   </div>
	   </div>
