<?php // This is where you add the page title, it also displays in the level 1 heading below
	...
	<ul class="bottomnav">
    <li><a href="note_18.php" class="back">Previous &#8211; Note 18</a></li><li><a href="#topnav" class="top">Top</a></li><li><a href="../index.php" class="next">Next &#8211 Financial statements</a></li>
	</ul>
   </div>
   </div>
   </div>
