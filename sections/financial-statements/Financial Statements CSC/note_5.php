<?php // This is where you add the page title, it also displays in the level 1 heading below
	...
	<h3>5.1: Reconciliation of the Opening and Closing Balances of Property, Plant and Equipment and Intangibles</h3>
		...
		<table class="column_bold">
			...
			<tbody>
				...
				<tr>
					<td>Acquired through restructuring</td>
					<td>5,446</td>
					<td>3,847</td>
					<td>20,572</td>
					<td>29,865</td>
				...
				<tr>
					<td>Revaluations and impairments recognised in other comprehensive</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				...
				<tr>
					<td>Impairments recognised in net contribution by services</td>
					<td>-</td>
					<td>-</td>
					<td>(244)</td>
					<td>(244)</td>
		...
		<p>
			<sup>1</sup> The carrying amount of computer software includes $0.658 million of purchased software and $19.471 million of internally generated software. A $0.244m impairment loss was recognised for internally developed generated software. No indicators of impairment were found for property, plant and equipment. No property, plant and equipment or intangibles are expected to be sold or disposed of within the next 12 months.
		</p>
	<h3>Revaluations of non-financial assets</h3>
		<p>
			All revaluations were conducted in accordance with the revaluation policy stated at Note 14.1. Independent valuers conducted the revaluations as at 30 June 2016.
		</p>
	<h3>Contractual commitments for the acquisition of property, plant, equipment and intangible assets</h3>
		<p>CSC have contractual commitments totalling $0.330 million for the acquisition of property, plant and equipment and intangible assets.</p>
			...
			<tbody>
				...
				<tr>
					<td>From disposal of entities or operations (including restructuring)</td>
					<td>-</td>
					<td>-</td>
					<td>-</td>
					<td>-</td>
	...
	<h3>Accounting Policy</h3>
		...
		<h4>Asset Recognition Threshold</h4>
			<p>
		...
		<h4>Depreciation</h4>
			<p>
				Depreciable property, plant and equipment assets are writtenoff to their estimated residual values over their estimated useful lives to the entity using, in all cases, the straight-line method of depreciation.
			</p>
			<p>
		...
		<h4>Accounting Judgements and Estimates</h4>
			<p>
    ...
    <ul class="bottomnav">
    <li><a href="note_4.php" class="back">Previous &#8211; Note 4</a></li><li><a href="#topnav" class="top">Top</a></li><li><a href="note_6.php" class="next">Next &#8211 Note 6</a></li>
	</ul>
   </div>
   </div>
   </div>
