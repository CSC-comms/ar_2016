<?php // This is where you add the page title, it also displays in the level 1 heading below
    ...
    <div class="container">
		...
		<div class="col-sm-8 col-xs-11 content" id="startContent">
			...
			<div class="row board-member">
				<div class="col-sm-3"><img src="../../images/Mr Anthony (Tony) Cole AO.JPG" class="img-responsive img-thumbnail" alt="Mr Anthony (Tony) Cole, AO" /></div>
				<div class="col-sm-9">
				<h3 class="callout bg-success">Mr Anthony (Tony) Cole, AO</h3>
						<h4>Reappointed 1 July 2016 to 30 June 2017</h4>
							<ul>
								<li>Director since 1 July 2011</li>
								<li>Member of the Board Governance Committee</li>
								<li>Member of the Remuneration and HR Committee</li>
							</ul>
							<p>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Mr Peter Feltham.JPG" class="img-responsive img-thumbnail" alt="Mr Peter Feltham" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Mr Peter Feltham</h3>
						<h4>Appointment ended 30 June 2016</h4>
							<ul>
								<li>Director since 1 July 2011</li>
								<li>Nominee of the President of the ACTU</li>
								<li>Member of the Audit and Risk Management Committee (at 30 June 2016)</li>
								<li>Member of the APS Reconsideration Advisory Committee (at 30 June 2016)</li>
							</ul>
							<p>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Ms Nadine Flood.JPG" class="img-responsive img-thumbnail" alt="Ms Nadine Flood" /></div>
			<div class="col-sm-9">	
			<h3 class="callout bg-success">Ms Nadine Flood</h3>
						<h4>Reappointed 1 July 2014 to 30 June 2017</h4>
							<ul>
								<li>Director since 1 July 2011</li>
								<li>Nominee of the President of the ACTU</li>
								<li>Member of the Audit and Risk Management Committee</li>
							</ul>
							<p>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Lyn Gearing.jpg" class="img-responsive img-thumbnail" alt="Ms Lyn Gearing" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Ms Lyn Gearing</h3>
						<h4>Reappointed 13 September 2013 to 12 September 2016</h4>
							<ul>
								<li>Director since 13 September 2011</li>
								<li>Member of the Audit and Risk Management Committee</li>
							</ul>
							<p>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/2015 08 21 - Winsome work photo.jpg" class="img-responsive img-thumbnail" alt="Ms Winsome Hall" /></div>
			<div class="col-sm-9">    	
					
					<h3 class="callout bg-success">Ms Winsome Hall</h3>
						<h4>Reappointed 1 July 2016 to 30 June 2019</h4>
							<ul>
								<li>Director since 1 July 2011</li>
								<li>Nominee of the President of the ACTU</li>
								<li>Member of the Board Governance Committee</li>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Mr John McCullagh.JPG" class="img-responsive img-thumbnail" alt="Mr John McCullagh" /></div>
			<div class="col-sm-9"> 
			<h3 class="callout bg-success">Mr John McCullagh</h3>
						<h4>Appointment ended on 30 June 2016</h4>
							<ul>
								<li>Director since 1 July 2011</li>
								<lI>Nominee of the Chief of the Defence Force</li>
								<lI>Member of the Audit and Risk Management Committee</li>
								<li>Chair of the APS Reconsideration Advisory Committee</li>
								<li>Deputy Chair of the MilitarySuper Reconsideration Committee</li>
								<li>Deputy Chair of the Defence Force Case Assessment Panel</li>
							</ul>
							<p>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Ms Peggy Haines.JPG" class="img-responsive img-thumbnail" alt="Ms Peggy O’Neal" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Ms Peggy O’Neal</h3>
						<h4>Reappointed 1 July 2014 to 30 June 2017</h4>
							<ul>
								<li>Director since 1 July 2011</li>
								<li>Member of the Board Governance Committee</li>
								<li>Member of the Remuneration and HR Committee</li>
								<lI>Member of the APS Reconsideration Advisory Committee</li>
							</ul>
							<p>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/M_Staib.jpg" class="img-responsive img-thumbnail" alt="Air Vice Marshal Margaret Staib, AM, CSC" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Air Vice Marshal Margaret Staib, AM, CSC</h3>
						<h4>Appointed 2 May 2014 to 1 May 2017</h4>
							<ul>
								<li>Nominee of the Chief of Defence Force</li>
								<li>Chair of the MilitarySuper Reconsideration Committee</li>
								<li>Chair of the Defence Force Case Assessment Panel</li>
							</ul>
							<p>
			...
			<div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Dr Michael John Vertigan AC.JPG" class="img-responsive img-thumbnail" alt="Dr Michael John Vertigan, AC" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Dr Michael John Vertigan, AC</h3>
						<h4>Appointment ended on 30 June 2016</h4>
							<ul>
								<li>Director since 1 July 2011</li>
								<li>Chair of the Audit and Risk Management Committee</li>
							</ul>
							<p>
				...
				<h2>New Directors in 2016–17</h2>
				
				
			  <div class="row board-member">
			<div class="col-sm-3"><img src="../../images/A_Barker.jpg" class="img-responsive img-thumbnail" alt="Ms Ariane Barker" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Ms Ariane Barker</h3>
						<h4>Appointed 13 September 2016 to 12 September 2019</h4>
							<p>
			  ...
			  <div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Garry-Hounsell.jpg" class="img-responsive img-thumbnail" alt="Mr Garry Hounsell" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Mr Garry Hounsell</h3>
						<h4>Appointed 1 July 2016 to 30 June 2019</h4>
							<ul>
								<li>Member of the Audit and Risk Management Committee</li>
							</ul>
							<p>
							...
							<p>
								Mr Hounsell was previously the Chair of Emitch Limited (2006-2008) and PanAust Limited (2008–2015). He was also previously a director at Orica Limited (2004–2013), Nufarm Limited (2004-2012), Qantas Airways Limited (2005-2015), and Mitchell Communication Group Limited (2008–2010).
							</p>
							<p>
			  ...
			  <div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Tony Needham.jpg" class="img-responsive img-thumbnail" alt="Air Vice-Marshal Tony Needham, AM" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Air Vice-Marshal Tony Needham, AM</h3>
						<h4>Appointed 1 July 2016 to 30 June 2019</h4>
							<ul>
								<li>Nominee of the Chief of the Defence Force</li>
								<li>Deputy Chair of the MilitarySuper Reconsideration Committee</li>
			  ...
			  <div class="row board-member">
			<div class="col-sm-3"><img src="../../images/Sunil Kemppi.jpg" class="img-responsive img-thumbnail" alt="Mr Sunil Kemppi" /></div>
			<div class="col-sm-9">
			<h3 class="callout bg-success">Mr Sunil Kemppi</h3>
						<h4>Appointed 1 July 2016 to 30 June 2019</h4>
							<ul>
								<li>Nominee of the President of the ACTU</li>
							</ul>
