	...
	<ul>
		...
		<div class="col-xs-8 content" id="startContent">
			...
			<p>
				...
				(Australia) Pty Ltd as part of a comprehensive review as at 30 June 2014. A summary of the report is attached.
			</p>
			<div class="wrapper_not_full">
				<table class="column_bold_tri">
					...
					<tbody>
						...
						<tr>
							<td>&nbsp;</td>
							<td class="border_top_bottom">66.9</td>
							<td class="border_top_bottom">64.5</td>
						</tr>
						<tr class="ar_fs_section_top">
