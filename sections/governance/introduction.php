<?php // This is where you add the page title, it also displays in the level 1 heading below
	...
	<ul>
        <li><a title="Governance" href="introduction.php">Governance</a></li>
	</ul>
		</div>
	...
	<ul>
		...
		<li>Board Renewal Policy</li>
		<li>Fit and Proper Policy</li>
		<li>Governance Statement</li>
		<li>Outsourcing Policy</li>
		<li>Conflicts Management Framework and Policy</li>
		<li>Whistleblower Protection Policy.</li>
	</ul>
	<p>
		All policies except for the Conflicts Management Framework and Policy are available on the CSC website at <a href="http://csc.gov.au/">csc.gov.au</a>
	</p>
	<p>
